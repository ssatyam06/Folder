...
//if(isset($_GET['add_cart']))
{
	...
	$sql = "INSERT INTO cart (p_id, customer_email, ip_add, qty) VALUES ('$pro_id', '$c_email', '$ip', 1)";
	...
	while($row_pro=mysqli_fetch_array($run_pro)){
		...
		echo "
				<div id='single_product'>
					...
					<input type='submit' style='float:right' name='add123' value='Add to Cart' />
					</form>
				</div>
		
		
		";
		if($_SERVER['REQUEST_METHOD']=="GET" && isset($_GET['add123']))
		{
